        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoodsReceiptNotes_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GoodsReceiptNotes_AspNetUsers_ReceivedByUserId",
                        column: x => x.ReceivedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoodsReceiptNotes_AspNetUsers_UpdatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceiptNotes_CreatedByUserId",
                table: "GoodsReceiptNotes",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceiptNotes_CreatedOn",
                table: "GoodsReceiptNotes",
                column: "CreatedOn");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceiptNotes_UpdatedByUserId",
                table: "GoodsReceiptNotes",
