...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#returnButton, .btn-return', function (e) {
            ...
            if (!purchaseOrderId) {
                console.error('No Purchase Order ID found on button.');
                return;
            }

            showReturnModalAndLoadUsers(purchaseOrderId);
        });
        ...
        $(document).on('submit', '#returnForm', function (e) {
            ...
            if (!userId) {
                e.preventDefault();
                showError('Please select a user to return the order to.');
                return false;
            }
     ...
     */
    function showReturnModalAndLoadUsers(purchaseOrderId) {
        console.log('🎯 Showing return modal for PR ID:', purchaseOrderId);
        ...
        const url = getUrl('Procurement', 'PurchaseOrder', 'GetPreviousWorkflowUsers');
        const orderData = { purchaseOrderId: purchaseOrderId };

        console.log('🌐 Making AJAX order to:', url);
