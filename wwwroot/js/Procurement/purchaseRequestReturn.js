...
(function ($) {
    ...
    function getUrl(area, page, action, id) {
        // You'll need to inject the base URL from your ASP.NET Core view.
        // For example, in the view file, add this line before the script tag:
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#returnButton, .btn-return', function (e) {
            ...
            const purchaseRequestId = $(this).data('purchase-request-id');

            if (!purchaseRequestId) {
                console.error('No Purchase Request ID found on button.');
                return;
            }

            showReturnModalAndLoadUsers(purchaseRequestId);
        });
     ...
     * @param {number} purchaseRequestId The ID of the purchase request.
     */
    function showReturnModalAndLoadUsers(purchaseRequestId) {
        ...
        const url = getUrl('Procurement', 'PurchaseRequest', 'GetPreviousWorkflowUsers');
        const requestData = { purchaseRequestId: purchaseRequestId };
