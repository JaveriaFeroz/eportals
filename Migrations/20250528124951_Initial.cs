        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisibleToRoles = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VisibleToUsers = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleRoleHierarchies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModuleRoleHierarchies_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_AspNetUsers_ApprovedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseRequestItems", x => x.ItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestApprovals_ApprovalLevels_ApprovalLevelId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Description", "IsActive", "MaxAmount", "MinAmount", "Name", "Order", "RequiredRole" },
                values: new object[,]
                {
                    { 1, "Department supervisor approval for small amounts", true, 1000m, 0m, "Supervisor Approval", 1, "Supervisor" },
                    { 2, "Department manager approval for medium amounts", true, 5000m, 1000m, "Manager Approval", 2, "Manager" },
                    { 3, "Finance manager approval for large amounts", true, 999999999999999.99m, 5000m, "Finance Approval", 3, "Finance Manager" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "User and role management", "User Management", true, "UserManagement" },
                    { 2, "Purchase request and procurement management", "Procurement", true, "Procurement" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Create purchase requests", true, 2, "CreatePurchaseRequest" },
                    { 2, "View own purchase requests", true, 2, "ViewOwnPurchaseRequests" },
                    { 3, "View all purchase requests", true, 2, "ViewAllPurchaseRequests" },
                    { 4, "Approve purchase requests", true, 2, "ApprovePurchaseRequests" },
                    { 5, "Edit purchase requests", true, 2, "EditPurchaseRequests" },
                    { 6, "Delete purchase requests", true, 2, "DeletePurchaseRequests" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalLevels_RequiredRole",
                table: "ApprovalLevels",
                column: "RequiredRole");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_BranchId_DepartmentId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModuleRoleHierarchies_RoleId_ModuleName",
                table: "ModuleRoleHierarchies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestApprovals_ApprovalLevelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestApprovals_PurchaseRequestId_ApprovalLevelId",
                table: "RequestApprovals",
                columns: new[] { "PurchaseRequestId", "ApprovalLevelId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RequestApprovals_Status",
                table: "RequestApprovals",
                column: "Status");
