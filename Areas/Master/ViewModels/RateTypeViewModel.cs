...
namespace ProcureToPay.Areas.Master.ViewModels
{
    ...
    public class RateTypeListViewModel
    {
        public short TypeId { get; set; }
        public string TypeName { get; set; }
    ...
    public class RateTypeIndexViewModel
    {
        public List<RateTypeListViewModel> RateTypes { get; set; } = new List<RateTypeListViewModel>();
