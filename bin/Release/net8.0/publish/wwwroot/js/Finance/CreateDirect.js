document.addEventListener('DOMContentLoaded', function () {
    ...
    // Get the Cost Allocation card element by its new ID
    ...
    let departments = [];
    let branches = [];
    let initialPaymentNatureId = 0; // New variable for the initial value
    ...
    window.initializePaymentRequestScript = function (data) {
        ...
        initialPaymentNatureId = data.initialPaymentNatureId; // Capture the initial value

        // Call the initial state setup after data is loaded
        toggleSelfApplicantFields();
        toggleCostAllocationSection(initialPaymentNatureId);
        ...
        // Add event listener to the Payment Nature dropdown
    ...
    // New function to toggle the visibility of the cost allocation section based on payment nature
    ...
    // ... (Your other functions like toggleSelfApplicantFields, updateOverallTotals, etc.)
    // ... (All functions below this point remain the same as your provided code)
